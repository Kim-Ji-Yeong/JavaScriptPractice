 ...
 * 1) 데이터 캐싱
 */
function casheFunction(newNumb) {
...
const GD = new Idol("GD", 1988);
console.log(GD.sayNameAndYear());

console.log(GD.name);
console.log(GD._year);
